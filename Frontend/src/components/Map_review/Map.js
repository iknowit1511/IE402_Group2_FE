...
import icon from '../../assets/icon_1.png'; // Đường dẫn đến biểu tượng nếu cần
  ...
  useEffect(() => {
    ...
    const withPoint = (data, index) => {
      ...
      return new Graphic({
        ...
        symbol: {
          type: 'picture-marker', // Sử dụng biểu tượng hình ảnh
          url: icon, // Đường dẫn đến biểu tượng
          width: '24px',
          height: '24px',
          yoffset: 10 // Điều chỉnh vị trí biểu tượng
        },
